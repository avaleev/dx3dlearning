...
{
	return "Deviant Graphics Exception";
}
...
{
	return "Deviant Graphics Exception [Device Removed] (DXGI_ERROR_DEVICE_REMOVED)";
}
...
const char* Graphics::InfoException::GetType() const noexcept {
	return "Deviant Graphics Info Exception";
}
